...
module Data.Bytes.Varint (varintEncode, varintToByteString, supplyVarint) where
...
varintToByteString :: Integral a => a -> ByteString.ByteString
varintToByteString = ByteString.pack . varintEncode
